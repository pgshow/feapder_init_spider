...
# PGSQL_USER_PASS = "postgres"

# REDIS
# ip:port 多个可写为列表或者逗号隔开 如 ip1:port1,ip2:port2 或 ["ip1:port1", "ip2:port2"]

REDISDB_IP_PORTS = "192.168.187.128:6379"
...
ITEM_PIPELINES = [
    ...
    # "pipelines.custom_pipeline.Pipeline",
]
EXPORT_DATA_MAX_FAILED_TIMES = 20  # 导出数据时最大的失败次数，包括保存和更新，超过这个次数报警
EXPORT_DATA_MAX_RETRY_TIMES = 20  # 导出数据时最大的重试次数，包括保存和更新，超过这个次数则放弃重试
...
# 设置代理
PROXY_TUNNEL = {"https": f"https://xxx:24000", "http": f"http://xxx:24000"}
PROXY_TUNNEL_ENABLE = False
